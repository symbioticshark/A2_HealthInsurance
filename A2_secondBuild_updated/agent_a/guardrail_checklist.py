...
Run directly: `python3 -m agent_a.guardrail_checklist` from
A2_secondBuild_updated/, or `python3 agent_a/guardrail_checklist.py`.
Writes guardrail_checklist_report.json next to this file's parent
directory (the project root) so it sits alongside the other measurement
reports.
"""
import json
import os
...
if __package__ in (None, ""):
    ...
    from agent_a import guardrails as G
    from agent_a import tools as T
    from agent_a import loop
...
def main():
    ...
    out_path = os.path.join(
        ...
        "guardrail_checklist_report.json",
    )
